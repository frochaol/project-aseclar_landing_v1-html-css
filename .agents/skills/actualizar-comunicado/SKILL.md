...
description: Skill para actualizar el Comunicado Oficial principal en index.html, archivar el comunicado previo en el historial de forma cronológica inversa, y gestionar imágenes/videos asociados en la carpeta assets.
---

# Instrucciones para Actualizar el Comunicado Principal

Este "Skill" se activa automáticamente cuando el usuario solicita actualizar el comunicado oficial, aviso importante, banner principal o noticias destacadas del inicio en `index.html`.
